...
namespace Unity.FPS.UI
{
    public class InGameMenuManager : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (!MenuRoot.activeSelf && ControlFreak2.CF2Input.GetMouseButtonDown(0))
            {
            ...
            if (ControlFreak2.CF2Input.GetButtonDown(GameConstants.k_ButtonNamePauseMenu)
                || (MenuRoot.activeSelf && ControlFreak2.CF2Input.GetButtonDown(GameConstants.k_ButtonNameCancel)))
            {
            ...
            if (ControlFreak2.CF2Input.GetAxisRaw(GameConstants.k_AxisNameVertical) != 0)
            {
